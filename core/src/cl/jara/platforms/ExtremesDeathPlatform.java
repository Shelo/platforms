...
public class ExtremesDeathPlatform extends Platform {
	public static float EXTREME_MARGIN = 25;

	public ExtremesDeathPlatform(float x, float y) {
		super(x, y);
	}
	...
	public Platform copy(float x, float y) {
		return new ExtremesDeathPlatform(x, y);
	}
}
